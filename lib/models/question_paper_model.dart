//model is basically for the json(Map in flutter) format of the question
//we read data and present it in good form kind of list and start reading from inside then goes outside
...
class QuestionPaperModel {
  ...
  QuestionPaperModel.fromSnaphot(DocumentSnapshot<Map<String, dynamic>> json)
      : id = json.id,
        title = json['title'],
